    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200
        ...
        <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-lg font-bold text-blue-600 uppercase">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-4">
                ...
                <div>
                    ...
                    <div class="p-4 bg-slate-50 rounded-xl text-slate-700
                                text-sm whitespace-pre-line border border-slate-100">
                        {{ $ticket->description }}
                    </div>
                ...
                @if($ticket->image_proof)
                    ...
                    <div>
                        ...
                        <a
                            href="{{ asset('storage/' . $ticket->image_proof) }}"
                            target="_blank"
                            class="inline-block"
                        >

                            <img
                                src="{{ asset('storage/' . $ticket->image_proof) }}"
                                alt="Bukti Kerusakan"
                                class="h-48 w-auto rounded-xl object-cover
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-4">
                ...
                <h3 class="text-lg font-bold text-slate-800
                           border-b border-slate-100 pb-3">
                    Tambah Catatan Perbaikan (Log)
                </h3>


                <form
                    action="{{ route('tickets.addLog', $ticket->id) }}"
                    method="POST"
                    class="space-y-4"
                >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="3"
                            required
                            placeholder="Contoh: Mengganti RAM DDR4 8GB dan membersihkan kipas..."
                            class="w-full text-sm rounded-xl border-slate-300
                    ...
                    <button
                        type="submit"
                        class="px-4 py-2.5 text-sm font-semibold text-white
                               bg-slate-800 rounded-xl hover:bg-slate-900
                ...
                <div class="mt-6 space-y-3 pt-4 border-t border-slate-100">
                    ...
                    @forelse($ticket->logs as $log)
                        ...
                        <div class="p-3.5 bg-slate-50 rounded-xl
                                    border border-slate-200 text-sm space-y-1">

                            <div class="flex flex-col sm:flex-row sm:justify-between
                                        gap-1 font-semibold text-slate-800">

                                <span>
                                    {{ $log->technician->name ?? 'Teknisi' }}
                                </span>
                    ...
                    @empty
                        ...
                        <p class="text-sm text-slate-400 italic">
                            Belum ada tindakan perbaikan yang dicatat.
                        </p>
            ...
            {{-- =================================================
                 EVIDENCE GALLERY
                 ================================================= --}}
            @include('tickets.partials.evidence-gallery', [
                'ticket' => $ticket
            ])
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm
                        border border-slate-200 space-y-4">
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option
                                value="pending_sparepart"
                                {{ $ticket->status == 'pending_sparepart' ? 'selected' : '' }}
                            >
                                Pending Sparepart
                            </option>
                            ...
                            <option
                                value="cancelled"
                                {{ $ticket->status == 'cancelled' ? 'selected' : '' }}
                            >
                                Cancelled
                            </option>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            name="notes"
                            placeholder="Alasan update status..."
                            class="w-full text-sm rounded-xl border-slate-300
                                   focus:border-blue-500 focus:ring-blue-500 shadow-sm"
                        >
                    ...
                    <div class="relative border-l-2 border-slate-200 ml-3 space-y-6">
                        ...
                        @foreach($ticket->statusHistories as $history)
                            ...
                            <div class="ml-4 relative">
                                ...
                                <div
                                    class="absolute -left-[23px] top-1.5
